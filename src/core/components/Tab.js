  ...
  return (
    <div className="flex justify-center mt-6">
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? "flex items-center h-6 px-2 py-1 text-center text-gray-700 border border-b-0 border-slate-400 sm:px-4 dark:border-gray-500 rounded-t-md -px-1 dark:text-white whitespace-nowrap focus:outline-none"
            : "flex items-center h-6 px-2 py-1 text-center text-gray-700 bg-transparent border-b border-slate-400 sm:px-4 dark:border-gray-500 -px-1 dark:text-white whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400 dark:hover:border-slate-400"
        }
      >
        <AddIcon></AddIcon>
        <span className="mx-1 text-sm">New Todo</span>
      </NavLink>
    </div>
  );
}
